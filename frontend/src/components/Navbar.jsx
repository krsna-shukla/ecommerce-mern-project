...
function Navbar({ search, setSearch }) {
  ...
  return (
    <nav style={{
      ...
      {/* Search Bar */}
      <div style={{ flex: 1, maxWidth: "420px", display: "flex", alignItems: "center", background: "#252525", border: "1px solid #2E2E2E", borderRadius: "8px", padding: "7px 14px", gap: "8px" }}>
      ...
      {/* Nav Links */}
      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "1.75rem" }}>
        {role === "admin" ? (
          <>
            {[{ to: "/admin", label: "Dashboard" }, { to: "/admin-products", label: "Products" }, { to: "/add-product", label: "Add Product" }, { to: "/admin/orders", label: "Orders" }].map(({ to, label }) => (
          ...
          <>
            ...
            {token && <Link to="/wishlist" style={{ ...navLinkStyle, color: "#D4A843" }}>♥ Wishlist</Link>}
...
const navLinkStyle = { color: "#999", fontSize: "0.82rem", letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none", fontFamily: "'Inter', sans-serif" };
